...
html[data-theme="escuro"] {
  ...
  --pink: #5A5D62;
  --pink-light: #2D2F33;
  --accent-purple: #6E7176;
  --accent-pink: #5A5D62;
  --accent-purple-tint: #2C2E31;
  --accent-pink-tint: #2C2E31;
  --text-dark: #F4F5F6;
  --text-muted: #9AA0A8;
  --border: #3B3E44;
  --green: #7FD9A8;
...
.theme-swatch-escuro { background: linear-gradient(135deg, #16171A, #6E7176); }
...
.due-soon-card { border-left: 4px solid var(--orange); }
.due-soon-list { display: flex; flex-direction: column; gap: 10px; }
.due-soon-list li { display: grid; grid-template-columns: 1fr auto auto; align-items: center; gap: 10px; font-size: 12.5px; }
.due-soon-desc { color: var(--text-dark); font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.due-soon-date { color: var(--orange); font-weight: 700; font-size: 11px; background: var(--accent-pink-tint); padding: 3px 8px; border-radius: 100px; }
