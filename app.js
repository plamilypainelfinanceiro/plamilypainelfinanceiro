...
const THEME_PALETTES = {
  ...
  escuro: { c1: "#9B85D6", c2: "#C99BB0" }
};
const THEME_COLORS = { lavanda: "#6B5B95", grafite: "#2C3E50", escuro: "#17141F" };
...
html[data-theme="escuro"] {
  ...
  --pink: #4A3F55;
  --pink-light: #2A2536;
  --accent-purple: #9B85D6;
  --accent-pink: #C99BB0;
  --accent-purple-tint: #322A44;
  --accent-pink-tint: #332A32;
  --text-dark: #EDE9F5;
  --text-muted: #9C93B0;
  --border: #362F45;
  --green: #6FCB9F;
...
.theme-swatch-escuro { background: linear-gradient(135deg, #17141F, #6B5B95); }
