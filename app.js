...
function OverviewView({ totals, categorySpendMonth, bars, balanceEvo, paymentMethodSpend, debtsSummary, upcoming, recent, goals, fixedVsVariable, openModal, userName, selY, selM, selDay, daySummary, budgets, monthProjection, safeLimit, smartInsights, top5Saidas, incomeByCategory, monthComparison, dueSoon }) {
  ...
  return /* @__PURE__ */ React.createElement("li", { key: u.id }, /* @__PURE__ */ React.createElement("div", { className: "due-item-info" }, /* @__PURE__ */ React.createElement("span", { className: "due-item-kind" }, u.kind), /* @__PURE__ */ React.createElement("span", { className: "due-item-desc" }, u.desc, " ", /* @__PURE__ */ React.createElement("span", { className: "due-item-paren" }, "(", dObj.toLocaleDateString("pt-BR", { day: "2-digit", month: "2-digit" }), ")"))), /* @__PURE__ */ React.createElement("div", { className: "due-item-right" }, /* @__PURE__ */ React.createElement("strong", null, fmt(u.value)), /* @__PURE__ */ React.createElement("span", { className: `due-item-badge ${isToday ? "overdue" : "soon"}` }, isToday ? "Venceu" : dObj.toLocaleDateString("pt-BR", { day: "2-digit", month: "short" }))));
