...
.due-soon-list li { display: grid; grid-template-columns: 1fr auto auto; align-items: center; gap: 10px; font-size: 12px; }
.due-soon-desc { color: var(--text-dark); font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.due-soon-date { color: var(--text-muted); font-weight: 600; font-size: 10.5px; background: var(--surface-alt); padding: 2px 7px; border-radius: 100px; }
