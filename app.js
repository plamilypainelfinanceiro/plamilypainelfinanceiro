...
function getStoredTheme() {
  try {
    return localStorage.getItem("plamily-theme") === "grafite" ? "grafite" : "lavanda";
  } catch (e) {
    return "lavanda";
  }
}
function applyThemeToDocument(t) {
  try {
    if (t === "grafite") document.documentElement.setAttribute("data-theme", "grafite");
    else document.documentElement.removeAttribute("data-theme");
    localStorage.setItem("plamily-theme", t);
    var meta = document.querySelector('meta[name="theme-color"]');
    if (meta) meta.setAttribute("content", t === "grafite" ? "#2C3E50" : "#6B5B95");
  } catch (e) {}
}
...
function FinancePlanner({ accountId, db: db2, userEmail, userName, onSignOut }) {
  var _a;
  ...
  useEffect(() => {
    const data = { entries, cards, purchases, debts, wishlist, goals, savings, investments, budgets, expenseCategories, incomeCategories, paymentMethods, debtTypes, categoryColors };
  ...
  }, [entries, cards, purchases, debts, wishlist, goals, savings, investments, budgets, expenseCategories, incomeCategories, paymentMethods, debtTypes, categoryColors]);
  ...
  const upcoming = useMemo(() => {
    const list = [];
    entries.filter((e) => e.status === "pendente").forEach((e) => list.push({ id: e.id, desc: e.desc, value: e.value, date: e.date, type: e.type }));
    allInstallmentsFlat.filter((i) => i.status === "pendente").forEach(
      (i) => list.push({ id: i.purchaseId + i.n, desc: `${i.desc} (parcela ${i.n})`, value: i.value, date: `${i.dueY}-${String(i.dueM + 1).padStart(2, "0")}-01`, type: "saida" })
    );
    debtInstallmentsFlat.filter((i) => i.status === "pendente").forEach(
      (i) => list.push({ id: i.debtId + i.n, desc: `${i.desc} (parcela ${i.n})`, value: i.value, date: `${i.dueY}-${String(i.dueM + 1).padStart(2, "0")}-01`, type: "saida" })
    );
...
function OverviewView({ totals, categorySpendMonth, bars, balanceEvo, paymentMethodSpend, debtsSummary, upcoming, recent, goals, fixedVsVariable, openModal, userName, selY, selM, selDay, daySummary, budgets, monthProjection, safeLimit, smartInsights, top5Saidas, incomeByCategory, monthComparison }) {
...
function CardsView({ cards, purchases, onToggleInstallment, openModal }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "stack-lg" }, /* @__PURE__ */ React.createElement("div", { className: "filter-row" }, /* @__PURE__ */ React.createElement("div", { className: "spacer" }), /* @__PURE__ */ React.createElement("button", { className: "btn-secondary sm", onClick: () => openModal("addCard") }, /* @__PURE__ */ React.createElement(Plus, { size: 14 }), "Novo cart\xE3o"), /* @__PURE__ */ React.createElement("button", { className: "btn-primary sm", onClick: () => openModal("addPurchase") }, /* @__PURE__ */ React.createElement(Plus, { size: 14 }), "Compra")), /* @__PURE__ */ React.createElement("div", { className: "cards-row" }, cards.map((c) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: p.id, className: "installment-block" }, /* @__PURE__ */ React.createElement("div", { className: "installment-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("strong", null, p.desc), /* @__PURE__ */ React.createElement("span", { className: "muted-sm" }, " \xB7 ", card == null ? void 0 : card.name, " \xB7 ", fmt(p.total))), /* @__PURE__ */ React.createElement("div", { className: "installment-head-actions" }, /* @__PURE__ */ React.createElement("button", { className: "icon-btn", title: "Editar", onClick: () => openModal({ kind: "editPurchase", purchase: p }) }, /* @__PURE__ */ React.createElement(Edit3, { size: 13 })), /* @__PURE__ */ React.createElement(Badge, { tone: "neutral" }, paidCount, "/", p.count, " pagas"))), /* @__PURE__ */ React.createElement(ProgressBar, { value: paidCount, max: p.count, colorVar: "var(--accent-purple)" }), /* @__PURE__ */ React.createElement("div", { className: "installment-chips" }, p.installments.map((i) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: i.n,
...
function HistoryView({ entries, purchases, debts, savings, investments, expenseCategories, incomeCategories, categoryColors }) {
  ...
  const all = [
    ...
    ...investments.map((i) => ({ date: i.date, desc: `Investimento: ${i.desc}`, category: "Investimento", value: i.value, type: "investimento", status: "pago" }))
...
.tone-green .sum-icon { background: #E1F5EC; color: var(--green); }
.tone-pink .sum-icon { background: var(--accent-pink-tint); color: var(--accent-pink); }
.tone-red .sum-icon { background: #FBE9EA; color: #D77E85; }
.tone-lavender .sum-icon { background: var(--accent-purple-tint); color: var(--accent-purple); }
.tone-blue .sum-icon { background: #E4EDFB; color: var(--blue); }
.tone-orange .sum-icon { background: #FBEDD8; color: var(--orange); }
.tone-dark .sum-icon { background: #E7E3EE; color: var(--text-dark); }
...
.qa-btn:hover { box-shadow: 0 4px 14px rgba(134,87,201,.15); transform: translateY(-1px); }
...
.mv-icon.entrada { background: #E1F5EC; color: #56B08A; }
...
.badge-green { background: #E1F5EC; color: #4FAE7E; }
.badge-orange { background: #FBEDD8; color: #C98718; }
.badge-pink { background: #FBE4EF; color: #C24B85; }
.badge-purple { background: var(--accent-purple-tint); color: var(--accent-purple); }
.badge-danger { background: #FBE0E4; color: #C94456; }
.badge-warning { background: #FBEDD8; color: #C98718; }
...
.icon-btn.danger { color: var(--danger); background: #FBE4E7; }
...
.seg-btn.sel { background: var(--surface); color: var(--accent-purple); box-shadow: 0 2px 6px rgba(134,87,201,.18); }
...
.month-projection-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px 16px; margin: 10px 0 14px; }
.month-projection-grid > div { display: flex; flex-direction: column; gap: 2px; }
.month-projection-grid span { font-size: 10.5px; color: var(--text-muted); font-weight: 600; }
.month-projection-grid strong { font-family: 'Fraunces', serif; font-size: 15px; color: var(--text-dark); }
...
.search-overlay {
  position: fixed; inset: 0; background: rgba(40,32,60,.38); z-index: 200;
...
.search-panel {
  ...
  box-shadow: 0 18px 50px rgba(40,32,60,.25); overflow: hidden;
}
...
.status-toggle.pago { background: #E1F5EC; color: #4FAE7E; }
.status-toggle.pendente { background: #FBEDD8; color: #C98718; }
...
.credit-card {
  ...
  box-shadow: 0 8px 24px rgba(134,87,201,.25); transition: transform .15s;
}
...
.inst-chip.atrasada { background: #F5D3DA; color: #B33A4C; box-shadow: inset 0 0 0 1.5px #D65C6E; }
...
/* Modal */
.modal-overlay {
  position: fixed; inset: 0; background: rgba(54, 43, 73, .35); display: flex; align-items: center; justify-content: center;
...
.toast {
  position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%); background: var(--text-dark); color: white;
      ...
      unsub = onAuthStateChanged(auth, async (u) => {
        ...
        if (u) {
          ...
          if (!licensed) {
            ...
            setLicenseError(
              "E-mail confirmado! Falta só a liberação do acesso, que a gente faz após a compra. " +
              "Ainda não comprou? Fale com o suporte: " + SUPPORT_EMAIL + " (resposta em até 6h)."
            );
            setDataLoading(false);
            setUser(null);
            setAuthChecked(true);
