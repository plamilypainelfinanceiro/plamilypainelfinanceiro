...
function FinancePlanner({ accountId, db: db2, userEmail, userName, onSignOut, onUpdateName }) {
  ...
  useEffect(() => {
    const data = { entries, cards, purchases, debts, wishlist, goals, savings, investments, budgets, expenseCategories, incomeCategories, paymentMethods, debtTypes, categoryColors, profilePhoto, openingBalance };
  ...
  }, [entries, cards, purchases, debts, wishlist, goals, savings, investments, budgets, expenseCategories, incomeCategories, paymentMethods, debtTypes, categoryColors, profilePhoto, openingBalance]);
