...
function DonutChartSVG({ data, size = 160 }) {
  ...
  return /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 160 160", width: size, height: size }, arcs.map((a, i) => /* @__PURE__ */ React.createElement("path", { key: i, d: a.path, fill: "none", stroke: a.d.color, strokeWidth: strokeW, strokeLinecap: "round" })), /* @__PURE__ */ React.createElement("text", { x: "80", y: "76", textAnchor: "middle", fontSize: "13", fontWeight: "700", fill: "var(--text-dark)" }, fmt(total)), /* @__PURE__ */ React.createElement("text", { x: "80", y: "92", textAnchor: "middle", fontSize: "9", fill: "var(--text-muted)" }, "total"));
}
...
function GoalsView({ goals, openModal }) {
...
function EntryModal({ type, expenseCategories, incomeCategories, paymentMethods, goals, cards, initial, onClose, onSave }) {
  ...
  const handleSave = () => {
    ...
    const useCard = type === "saida" && !isEditing && method === "Cr\xE9dito" && (kind === "unica" || kind === "parcelada") && cards && cards.length > 0;
