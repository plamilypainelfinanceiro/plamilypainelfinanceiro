...
function GoalsView({ goals, onDelete, openModal }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "stack-lg" }, /* @__PURE__ */ React.createElement("p", { className: "section-intro" }, "Para destinar dinheiro a uma meta, registre uma Sa\xEDda em Lan\xE7amentos e escolha \u201CMeta\u201D em \u201CDestinar para\u201D."), /* @__PURE__ */ React.createElement("div", { className: "filter-row" }, /* @__PURE__ */ React.createElement("div", { className: "spacer" }), /* @__PURE__ */ React.createElement("button", { className: "btn-primary sm", onClick: () => openModal("addGoal") }, /* @__PURE__ */ React.createElement(Plus, { size: 14 }), "Nova meta")), /* @__PURE__ */ React.createElement("div", { className: "goal-grid" }, goals.length === 0 ? /* @__PURE__ */ React.createElement(EmptyState, { icon: /* @__PURE__ */ React.createElement(Target, { size: 26 }), text: "Crie sua primeira meta financeira." }) : goals.map((g) => {
