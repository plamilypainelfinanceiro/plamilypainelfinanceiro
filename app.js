...
const THEME_PALETTES = {
  ...
  escuro: { c1: "#B9BDC3", c2: "#8B8F95" }
};
const THEME_COLORS = { lavanda: "#6B5B95", grafite: "#2C3E50", escuro: "#17181A" };
...
html[data-theme="escuro"] {
  ...
  --pink: #44464A;
  --pink-light: #2B2C2F;
  --accent-purple: #B9BDC3;
  --accent-pink: #A3A7AD;
  --accent-purple-tint: #34363A;
  --accent-pink-tint: #303234;
  --text-dark: #F3F4F5;
  --text-muted: #9FA3A8;
  --border: #3A3C3F;
  --green: #7FD9A8;
...
.theme-swatch-escuro { background: linear-gradient(135deg, #17181A, #B9BDC3); }
...
.password-eye-btn:hover { color: var(--accent-purple); }
.month-projection-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 14px 18px; margin: 10px 0 14px; }
@media (min-width: 900px) {
  .month-projection-grid { grid-template-columns: repeat(4, 1fr); gap: 14px 12px; }
}
