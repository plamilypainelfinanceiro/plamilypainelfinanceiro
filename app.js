...
.due-item-info { display: flex; flex-direction: column; align-items: center; gap: 1px; min-width: 0; }
...
.due-item-right { display: flex; flex-direction: column; align-items: center; gap: 4px; flex-shrink: 0; }
