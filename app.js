...
const THEME_PALETTES = {
  ...
  escuro: { c1: "#8FA3C4", c2: "#C79FAE" }
};
const THEME_COLORS = { lavanda: "#6B5B95", grafite: "#2C3E50", escuro: "#16171A" };
...
html[data-theme="escuro"] {
  ...
  --pink: #4A4C50;
  --pink-light: #2D2F33;
  --accent-purple: #8FA3C4;
  --accent-pink: #C79FAE;
  --accent-purple-tint: #29303B;
  --accent-pink-tint: #332A2F;
  --text-dark: #F4F5F6;
  --text-muted: #9AA0A8;
  --border: #3B3E44;
  --green: #7FD9A8;
...
.theme-swatch-escuro { background: linear-gradient(135deg, #16171A, #8FA3C4); }
...
.password-field-wrap {
  ...
  background: var(--surface-alt); border: 1px solid var(--border); border-radius: 11px;
}
.password-field-wrap input {
  padding-right: 38px; background: transparent; border: none; border-radius: 11px;
}
.password-field-wrap input:focus { outline: none; }
.password-field-wrap:focus-within { outline: 2px solid var(--accent-purple); outline-offset: 1px; }
.password-eye-btn {
...
.month-projection-grid span { font-size: 10.5px; color: var(--text-muted); font-weight: 600; display: block; min-height: 26px; line-height: 1.3; }
