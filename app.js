...
function FinancePlanner({ accountId, db: db2, userEmail, userName, onSignOut, onUpdateName, theme, onSetTheme }) {
  ...
  useEffect(() => {
    const data = { entries, cards, purchases, debts, wishlist, goals, savings, investments, budgets, expenseCategories, incomeCategories, paymentMethods, debtTypes, categoryColors, profilePhoto, openingBalance, theme };
  ...
  }, [entries, cards, purchases, debts, wishlist, goals, savings, investments, budgets, expenseCategories, incomeCategories, paymentMethods, debtTypes, categoryColors, profilePhoto, openingBalance, theme]);
  ...
  const addEntry = (entry) => {
    ...
    if (destino === "guardado") {
      ...
      setSavings((prev) => prev.map((s) => s.id === goalId ? { ...s, value: Math.max(0, s.value - rest.value) } : s));
    } else if (destino === "retirar_investimento" && goalId) {
      setInvestments((prev) => prev.map((i) => i.id === goalId ? { ...i, value: Math.max(0, i.value - rest.value) } : i));
    }
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "app-root" }, /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("aside", { className: "sidebar" }, /* @__PURE__ */ React.createElement("div", { className: "brand" }, /* @__PURE__ */ React.createElement("div", { className: "brand-mark" }, /* @__PURE__ */ React.createElement("img", { src: "./icon-192.png", alt: "Plamily", className: "brand-mark-img" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "brand-title" }, "Plamily"), /* @__PURE__ */ React.createElement("div", { className: "brand-sub" }, "painel financeiro"))), /* @__PURE__ */ React.createElement("nav", { className: "side-nav" }, NAV.map((n) => /* @__PURE__ */ React.createElement(
    ...
    setModal(null);
  } }), modal === "addTransfer" && /* @__PURE__ */ React.createElement(TransferModal, { onClose: () => setModal(null), onSave: (t) => {
    addTransfer(t);
    setModal(null);
...
function EntryModal({ type, expenseCategories, incomeCategories, paymentMethods, goals, savings, investments, cards, initial, onClose, onSave }) {
