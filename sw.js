...
const CACHE_NAME = "plamily-shell-v4";
  ...
  event.respondWith(
    fetch(event.request)
      ...
      .catch(async () => {
        ...
        // 2) se for uma navegação (abrir o app), devolve o index do cache, e só
        // aqui pode valer uma página HTML de reserva — nunca para script/CSS/etc,
        // porque o navegador tentaria interpretar esse HTML como se fosse aquele
        // outro tipo de arquivo, e trava tudo (foi exatamente isso que quebrou).
        ...
        // 3) qualquer outro recurso (script, CSS, imagem) que falhou e não está
        // em cache: deixa a falha acontecer de verdade, sem inventar conteúdo.
